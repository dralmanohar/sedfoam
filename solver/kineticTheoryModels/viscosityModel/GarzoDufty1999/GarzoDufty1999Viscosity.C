...
#include "GarzoDufty1999Viscosity.H"
...
{
    defineTypeNameAndDebug(GarzoDufty1999Viscosity, 0);
    addToRunTimeSelectionTable(viscosityModel, GarzoDufty1999Viscosity, dictionary);
...
Foam::kineticTheoryModels::GarzoDufty1999Viscosity::GarzoDufty1999Viscosity
(
...
Foam::kineticTheoryModels::GarzoDufty1999Viscosity::mua
(
...
Foam::tmp<Foam::volScalarField>
Foam::kineticTheoryModels::GarzoDufty1999Viscosity::lambda
(
    const volScalarField& alpha,
    const volScalarField& Theta,
    const volScalarField& g0,
