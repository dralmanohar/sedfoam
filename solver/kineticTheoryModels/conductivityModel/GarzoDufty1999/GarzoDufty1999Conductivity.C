...
#include "GarzoDufty1999Conductivity.H"
...
namespace Foam
{
    defineTypeNameAndDebug(GarzoDufty1999Conductivity, 0);

    addToRunTimeSelectionTable
    (
        conductivityModel,
        GarzoDufty1999Conductivity,
        dictionary
    );
}
...
Foam::GarzoDufty1999Conductivity::GarzoDufty1999Conductivity(const dictionary& dict)
:
...
Foam::GarzoDufty1999Conductivity::~GarzoDufty1999Conductivity()
{}


// * * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * //

Foam::tmp<Foam::volScalarField> Foam::GarzoDufty1999Conductivity::kappa
(
