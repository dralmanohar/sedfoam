...
void twophasekOmegaVegTest<BasicTurbulenceModel>::correctNut()
{
    this->nut_ = k_/
    (
...
template<class BasicTurbulenceModel>
twophasekOmegaVegTest<BasicTurbulenceModel>::twophasekOmegaVegTest
(
...
template<class BasicTurbulenceModel>
bool twophasekOmegaVegTest<BasicTurbulenceModel>::read()
{
...
template<class BasicTurbulenceModel>
void twophasekOmegaVegTest<BasicTurbulenceModel>::correct()
{
    ...
    (
      ...
      // Production of dissipation due to vegetation drag$
      + fvc::Sp(KE7_*omegaw_, omegaw_)
    );
    if (writeTke_)
    {
        #include "writeTKEBudget_kOmegaVegTest.H"
    }
    omegaEqn.ref().relax();
    ...
    (
      ...
      + ESD2()*fvm::Sp(KE2_, k_)
      + fvm::Sp(KE6_*ESD6_/k_, k_) //turbulent production by vegetation drag force
    );
